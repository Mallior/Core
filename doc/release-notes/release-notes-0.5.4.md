Mallior version 0.5.4 is now available for download at:
http://sourceforge.net/projects/mallior/files/Mallior/mallior-0.5.4/
...
http://gitorious.org/mallior/malliord-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Mallior-Qt notifications under Growl 1.3.
Increase required age of Mallior-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMallior properly when installing Mallior-Qt over it. (Windows)
