Download URL: https://sourceforge.net/projects/mallior/files/Mallior/mallior-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 MLR fee schedule (users still pay 0.01 MLR per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #mallior00 - #mallior99
