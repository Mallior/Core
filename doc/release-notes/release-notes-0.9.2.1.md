Mallior Core version 0.9.2.1 is now available from:

  https://mallior.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 MLR to 0.01 MLR
...
- Fix "Start mallior on system login"
