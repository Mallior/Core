Mallior Core version 0.10.4 is now available from:

  <https://mallior.org/bin/mallior-core-0.10.4/>
...
- #6953 `43c2789` Split mallior-tx into its own package
- #6953 `dfe0d4d` Include mallior-tx binary on Debian/Ubuntu
