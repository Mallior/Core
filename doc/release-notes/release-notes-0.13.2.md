Mallior Core version 0.13.2 is now available from:

  <https://mallior.org/bin/mallior-core-0.13.2/>
...
- #8908 `4a974b2` Update mallior-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow mallior-tx to create v2 transactions (mlrdrak)
