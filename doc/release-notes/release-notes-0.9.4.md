Mallior Core version 0.9.4 is now available from:

  https://mallior.org/bin/0.9.4/
...
this update is incompatible with the Mallior system and could lead to consensus
forks.

Mallior Core released binaries from https://mallior.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~mallior/+archive/ubuntu/mallior
- A third-party or self-compiled Mallior Core

upgrade to Mallior Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
