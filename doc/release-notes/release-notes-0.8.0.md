Mallior-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/mallior/files/Mallior/mallior-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Mallior
...
New/changed settings (command-line or mallior.conf file)
--------------------------------------------------------
