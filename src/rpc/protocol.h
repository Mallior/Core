...
#ifndef MALLIOR_RPC_PROTOCOL_H
#define MALLIOR_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in malliord
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Mallior is not connected
