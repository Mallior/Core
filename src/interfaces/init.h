...
#ifndef MALLIOR_INTERFACES_INIT_H
#define MALLIOR_INTERFACES_INIT_H
...
//! (mallior-gui, mallior-node, mallior-wallet, malliord, mallior-qt) and each
...
#endif // MALLIOR_INTERFACES_INIT_H
