...
#ifndef MALLIOR_INTERFACES_NODE_H
#define MALLIOR_INTERFACES_NODE_H
...
//! Top-level interface for a mallior node (malliord process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or mallior.conf.
...
#endif // MALLIOR_INTERFACES_NODE_H
