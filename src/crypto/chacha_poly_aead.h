...
#ifndef MALLIOR_CRYPTO_CHACHA_POLY_AEAD_H
#define MALLIOR_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@mallior.
 *
 ...
 *
 * The chacha20-poly1305@mallior combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@mallior cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@mallior are relatively fast in
...
#endif // MALLIOR_CRYPTO_CHACHA_POLY_AEAD_H
