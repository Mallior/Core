...
//! Entry point for MalliorApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &MalliorApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for MalliorGUI tests.
void AppTests::guiTests(MalliorGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &MalliorGUI::consoleShown, this, &AppTests::consoleTests);
