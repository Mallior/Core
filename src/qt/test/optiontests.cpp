...
{
    // Test regression https://github.com/mallior/mallior/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/mallior-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/mallior-core/gui/pull/568.
    // With fListen=false in ~/.config/Mallior/Mallior-Qt.conf and all else left as default,
    // mallior-qt should set both -listen and -listenonion to false and start successfully.
