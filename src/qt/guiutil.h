...
#ifndef MALLIOR_QT_GUIUTIL_H
#define MALLIOR_QT_GUIUTIL_H
...
/** Utility functions used by the Mallior Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "mallior:" URI into recipient object, return true on successful parsing
