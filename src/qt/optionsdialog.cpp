      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->malliorAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->malliorAtStartup);
    ...
    ui->malliorAtStartup->setToolTip(ui->malliorAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->malliorAtStartup->setText(ui->malliorAtStartup->text().arg(PACKAGE_NAME));

    ui->openMalliorConfButton->setToolTip(ui->openMalliorConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new MalliorUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->malliorAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSMLRontrols);
...
void OptionsDialog::on_openMalliorConfButton_clicked()
{
