 ...
 * for both malliord and mallior-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Mallior");
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/mallior/bips/blob/master/bip-0014.mediawiki)
 */
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/mallior/mallior>";
