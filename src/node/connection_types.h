...
#ifndef MALLIOR_NODE_CONNECTION_TYPES_H
#define MALLIOR_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/mallior-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Mallior’s Peer-to-Peer Network")
...
#endif // MALLIOR_NODE_CONNECTION_TYPES_H
