...
#ifndef MALLIOR_ARITH_UINT256_H
#define MALLIOR_ARITH_UINT256_H
...
public:
     ...
     *
     * Mallior only uses this "compact" format for encoding difficulty
