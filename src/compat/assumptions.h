...
#ifndef MALLIOR_COMPAT_ASSUMPTIONS_H
#define MALLIOR_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Mallior cannot be compiled without assertions."
#endif
...
#endif // MALLIOR_COMPAT_ASSUMPTIONS_H
