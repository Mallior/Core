 ...
 */
#ifndef MALLIOR_UTIL_SYSTEM_H
#define MALLIOR_UTIL_SYSTEM_H
...
extern const char * const MALLIOR_CONF_FILENAME;
extern const char * const MALLIOR_SETTINGS_FILENAME;
