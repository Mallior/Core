...
#ifndef MALLIOR_UTIL_SYSCALL_SANDBOX_H
#define MALLIOR_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during malliord initialization if Mallior Core was compiled
...
#endif // MALLIOR_UTIL_SYSCALL_SANDBOX_H
