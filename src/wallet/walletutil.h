...
#ifndef MALLIOR_WALLET_WALLETUTIL_H
#define MALLIOR_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! mallior from opening the wallet, thinking it was newly created, and
...
#endif // MALLIOR_WALLET_WALLETUTIL_H
