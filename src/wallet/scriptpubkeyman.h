...
#ifndef MALLIOR_WALLET_SCRIPTPUBKEYMAN_H
#define MALLIOR_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Mallior Core wallet was originally a collection of unrelated private
...
#endif // MALLIOR_WALLET_SCRIPTPUBKEYMAN_H
