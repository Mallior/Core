...
#ifndef MALLIOR_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define MALLIOR_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // MALLIOR_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
