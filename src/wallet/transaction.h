...
#ifndef MALLIOR_WALLET_TRANSACTION_H
#define MALLIOR_WALLET_TRANSACTION_H
...
public:
     ...
     * on this mallior node, and set to 0 for transactions that were created
...
#endif // MALLIOR_WALLET_TRANSACTION_H
