...
#ifndef MALLIOR_SCRIPT_STANDARD_H
#define MALLIOR_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a mallior address
 */
...
/**
 * Generate a Mallior scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // MALLIOR_SCRIPT_STANDARD_H
