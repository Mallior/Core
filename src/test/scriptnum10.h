...
#ifndef MALLIOR_TEST_SCRIPTNUM10_H
#define MALLIOR_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Mallior Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // MALLIOR_TEST_SCRIPTNUM10_H
