...
{
    BOOST_CHECK(TestSplitHost("www.malliorcore.org", "www.malliorcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.malliorcore.org]", "www.malliorcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.malliorcore.org:80", "www.malliorcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.malliorcore.org]:80", "www.malliorcore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:18266", "127.0.0.1", 18266));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:18266", "127.0.0.1", 18266));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:18266", "::ffff:127.0.0.1", 18266));
    BOOST_CHECK(TestSplitHost("[::]:18266", "::", 18266));
    BOOST_CHECK(TestSplitHost("::18266", "::18266", 0));
    BOOST_CHECK(TestSplitHost(":18266", "", 18266));
    BOOST_CHECK(TestSplitHost("[]:18266", "", 18266));
    ...
    BOOST_CHECK(TestSplitHost("www.malliorcore.org:65536", "www.malliorcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.malliorcore.org:0", "www.malliorcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.malliorcore.org:", "www.malliorcore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:18266", "127.0.0.1:18266"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:18266", "[::]:18266"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
