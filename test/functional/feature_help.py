...
"""Verify that starting mallior with -h works as expected."""

from test_framework.test_framework import MalliorTestFramework
from test_framework.util import assert_equal

class HelpTest(MalliorTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mallior with -h for help text")
        ...
        self.log.info("Start mallior with -version for version information")
        ...
        self.log.info("Start malliord with -fakearg to make sure it does not start")
