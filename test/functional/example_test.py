...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MalliorTestFramework
    pass


class ExampleTest(MalliorTestFramework):
    # Each functional test is a subclass of the MalliorTestFramework class.
    ...
    def custom_method(self):
        ...
        MalliorTestFramework class so other tests can use it."""
