...
class TestShell:
    """Wrapper Class for MalliorTestFramework.

    The TestShell class extends the MalliorTestFramework
    ...
    class __TestShell(MalliorTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by MalliorTestFramework child class.
            self.num_nodes = 1
