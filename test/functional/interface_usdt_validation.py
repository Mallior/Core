...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/mallior/mallior/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(MalliorTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/mallior/mallior/blob/master/doc/tracing.md#tracepoint-validationblock_connected
