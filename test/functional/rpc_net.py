...
class NetTest(MalliorTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=18266)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 18266)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=18266), {"success": False})
