...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/mallior/mallior/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(MalliorTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our malliord node")
