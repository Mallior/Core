...
"""
Test starting malliord with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(MalliorTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that malliord has bound on "::1" (for RPC) and "::" (for P2P).
