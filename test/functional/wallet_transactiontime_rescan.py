...
class TransactionTimeRescanTest(MalliorTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine MLR and create transactions
        ...
        # generate some mlr to create transactions and check blockcount
        ...
        # send 10 mlr to user's first watch-only address
        self.log.info('Send 10 mlr to user')
        ...
        # send 5 mlr to our second watch-only address
        self.log.info('Send 5 mlr to user')
        ...
        # send 1 mlr to our third watch-only address
        self.log.info('Send 1 mlr to user')
