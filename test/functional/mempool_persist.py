...
By default, malliord will dump mempool on shutdown and
...
class MempoolPersistTest(MalliorTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent malliord from writing mempool.dat to disk. Verify that `savemempool` fails")
