...
class TxnMallTest(MalliorTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 MLR:
        ...
        # First: use raw transaction API to send 1240 MLR to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 MLR coin each
        ...
        # Node0's balance should be starting balance, plus 50MLR for another
        ...
        # Node0's total balance should be starting balance, plus 100MLR for
