...
Verify that a malliord node can use an external signer command.
...
class RPCSignerTest(MalliorTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart malliord with -signer=<cmd>',
