...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef MALLIOR_CHAINPARAMSSEEDS_H\n')
    g.write('#define MALLIOR_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the mallior network\n')
    ...
    g.write('#endif // MALLIOR_CHAINPARAMSSEEDS_H\n')
