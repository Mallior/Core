...
""" Interactive malliord P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Mallior Core can enable. It uses BCC
...
def main(malliord_path):
    ...
    malliord_with_usdts.enable_probe(
