...
"""Example logging Mallior Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/malliord
...
def main(malliord_path):
    ...
    b = BPF(text=program, usdt_contexts=[malliord_with_usdts])
