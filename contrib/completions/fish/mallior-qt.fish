...
complete --command mallior-qt --no-files

# Extract options
function __fish_malliorqt_get_options
...
complete \
    --command mallior-qt \
    --arguments "(__fish_malliorqt_get_options --nofiles)"
