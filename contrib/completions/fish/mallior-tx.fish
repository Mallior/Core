...
# Extract options
function __fish_mallior_tx_get_options
...
# Extract commands
function __fish_mallior_tx_get_commands
...
complete \
    --command mallior-tx \
    --condition "not __fish_mallior_seen_cmd (__fish_mallior_tx_get_commands --commandsonly)" \
    --arguments "(__fish_mallior_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command mallior-tx \
    --arguments "(__fish_mallior_tx_get_commands)" \
    --no-files
