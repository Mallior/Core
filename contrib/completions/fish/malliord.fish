...
complete --command malliord --no-files

# Extract options
function __fish_malliord_get_options
...
complete \
    --command malliord \
    --arguments "(__fish_malliord_get_options --nofiles)"
