...
Arguments:
    <base_directory> - The base directory of a mallior source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Mallior Core developers'
...
Arguments:
    <file> - A source file in the mallior repository.
"""
